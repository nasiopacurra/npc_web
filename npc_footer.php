<footer>
	...
	<section id="footer-center">
		<ul id="footer-nav">
			...
			<li><a href="/wp1">Reflexiones</a></li>
			<li><a href="/wiki">Contenidos</a></li>
			<li><a href="/oc">Tienda</a></li>
			<li><a href="manualidades.php">Manualidades</a></li>
			<li><a href="enlaces.php">Enlaces</a></li>
			<li><a href="organizacion.php">Orden</a></li>
			<li><a href="descarga.php">Descargas</a></li>
			<li><a href="contacto.php">Contacto</a></li>
		</ul>
		
		<div class="fooler-links">
			<a href="privacy.php">Politica de Privacidad</a>
			<a href="terms.php">Terminos y Condiciones</a>
		</div>
	</section>
	
	<section id="footer-right">
		<a target="_blank" id="curri-link" href="http://www.nasiopacurra.es/">NasioPaCurra</a>
	</section>
